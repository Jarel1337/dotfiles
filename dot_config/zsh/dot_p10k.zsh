# Generated by Powerlevel10k configuration wizard on 2021-04-25 at 14:58 CEST.
...
() {
  ...
  if [[ -f /run/.containerenv && -f /run/.toolboxenv ]]; then
    # Show hostname when inside toolbox
    typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%180F%m'
    typeset -g POWERLEVEL9K_CONTEXT_VISUAL_IDENTIFIER_EXPANSION='⬢'
  else
    # Show context when running with privileges or in SSH.
